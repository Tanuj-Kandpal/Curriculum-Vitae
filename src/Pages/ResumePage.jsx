  ...
  return (
    <div
      className={`min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8  ${
        mode ? "bg-gray-950" : "bg-blue-950"
      }`}
    >
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="md:flex">
          <div className="p-8">
            <div className="flex items-center justify-between uppercase tracking-wide text-sm text-indigo-500 font-semibold">
              Software Engineer
              <div className="">
                <button onClick={handleMode}>
                  {mode ? (
                    <MdModeNight className="h-8 w-8 text-black" />
                  ) : (
                    <MdOutlineLightMode className="h-8 w-8 text-black" />
                  )}
                </button>
              </div>
            </div>
            ...
            <p className="mt-4 max-w-3xl text-xl text-gray-500">
              Experience and proficient in developing scalable and
              high-performance software solutions for clients. Skilled with
              hands-on experience in React.js, HTML, CSS, JS. Adept at
              collaborating with cross-functional teams to deliver innovative
              solutions that meet and exceed client expectations.
            </p>
            <div className="mt-6 flex space-x-4">
              <a
                href="https://github.com/Tanuj-Kandpal"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/tanuj-kandpal-57186b193/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-gray-500"
              >
              ...
              <a
                href="mailto:takandpal@gmail.com"
                className="text-gray-400 hover:text-gray-500"
              >
